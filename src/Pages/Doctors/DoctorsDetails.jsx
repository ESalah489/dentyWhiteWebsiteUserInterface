...
//   if (loading) {
//     return (
//       <div className="flex items-center justify-center py-20" style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
...
//       <div className="relative py-20 px-4" style={{ background: 'linear-gradient(135deg, #e8f2ff 0%, #f1f8ff 100%)' }}>
...
//             </span>
//             <span style={{ color: '#64748b' }}>›</span>
//             <span style={{ color: '#1e293b' }}>{doctor.fullName}</span>
//           </div>
//         </div>
//       </div>
...
//               <h2 className="text-2xl font-bold text-gray-800 mb-3">{doctor.fullName}</h2>
...
//                   </div>
//                   <p className="text-lg font-bold text-blue-600">{doctor.experience} years</p>
//                 </div>
...
//                   </div>
//                   <p className="text-lg font-bold text-yellow-500">{doctor.averageRating?.toFixed(1) || "N/A"}</p>
//                 </div>
//               </div>
...
//           >
//             <h3 className="text-xl font-bold text-gray-800 mb-4">About Dr. {doctor.fullName.split(' ').pop()}</h3>
...
//             >
//               <h3 className="text-xl font-bold text-gray-800 mb-4">Work Gallery</h3>
...
//                       </div>
//                       <div>
//                         <p className="font-semibold text-sm text-gray-800">{rev.user.name}</p>
//                         <div className="flex items-center">
//                           {[...Array(5)].map((_, i) => (
//                             <svg
//                               key={i}
//                               className={`w-3 h-3 ${i < rev.rating ? 'text-yellow-400' : 'text-gray-300'}`}
//                               fill="currentColor"
//                               viewBox="0 0 20 20"
//                             >
//                               <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
...
//                   key={service._id}
//                   className="block bg-gray-50 rounded-lg p-4 hover:bg-gray-100 transition-colors duration-300 group"
//                 >
...
//                         <span className="text-sm font-bold text-green-600">{service.price} EGP</span>
//                       </div>
//                     </div>
//                   </div>
//                 </Link>
...
const DoctorDetails = () => {
  ...
  return (
    <div style={{ backgroundColor: '#f8fafc', minHeight: '100vh' }}>
      {/* 💠 Hero Section - Styled Header */}
      <div className="relative py-16 px-6 md:px-12 lg:px-24" style={{ background: 'linear-gradient(135deg, #e8f2ff 0%, #f1f8ff 100%)' }}>
        <div className="container mx-auto text-center">
      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-24 py-8">
        ...
        >
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            {/* Doctor Info */}
            <div className="flex-1 text-center md:text-left">
              <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-3">{doctor.fullName}</h2>
              ...
              <div className="grid grid-cols-2 gap-3 mb-4">
                <div className="bg-gray-50 p-2 rounded-lg text-center">
                  ...
                  <p className="text-base font-bold text-blue-600">{doctor.experience} years</p>
                </div>
                ...
                <div className="bg-gray-50 p-2 rounded-lg text-center">
                  ...
                  <p className="text-base font-bold text-yellow-500">{doctor.averageRating?.toFixed(1) || "N/A"}</p>
                </div>
              </div>
        ...
        {doctor.bio && (
          <motion.div 
            ...
            transition={{ duration: 0.6, delay: 0.3 }}
          >
            <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-4">About Dr. {doctor.fullName.split(' ').pop()}</h3>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {doctor.workImages?.length > 0 && (
            <motion.div 
              ...
              transition={{ duration: 0.6, delay: 0.4 }}
            >
              <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-4">Work Gallery</h3>
              <div className="grid grid-cols-2 gap-3">
                {doctor.workImages.slice(0, 4).map((img, idx) => (
                  <div key={idx} className="relative rounded-lg overflow-hidden group cursor-pointer">
                    <img
          ...
          <motion.div 
            ...
            transition={{ duration: 0.6, delay: 0.5 }}
          >
            <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-4">Patient Reviews</h3>
            {reviews.length > 0 ? (
              <div className="space-y-4 max-h-64 overflow-y-auto">
                {reviews.slice(0, 3).map((rev) => (
                  <div key={rev._id} className="bg-gray-50 p-3 rounded-lg">
                    <div className="flex items-center mb-2">
                      ...
                      <div>
                        <p className="font-semibold text-xs text-gray-800">{rev.user.name}</p>
                        <div className="flex items-center">
                          {[...Array(5)].map((_, i) => (
                            <svg
                              key={i}
                              className={`w-2.5 h-2.5 ${i < rev.rating ? 'text-yellow-400' : 'text-gray-300'}`}
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
        ...
        {doctor.services?.length > 0 && (
          <motion.div 
            ...
            transition={{ duration: 0.6, delay: 0.6 }}
          >
            <h3 className="text-lg md:text-xl font-bold text-gray-800 mb-4">Services Offered</h3>
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between items-center mt-1">
                        <span className="text-2xs text-gray-500">{service.category?.name}</span>
                        <span className="text-xs font-bold text-green-600">{service.price} EGP</span>
                      </div>
                    </div>
                  </div>
                </Link>
