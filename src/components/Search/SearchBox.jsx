...
// //         <div
// //           ref={suggestionsRef}
// //           className="absolute top-full left-0 right-0 bg-white shadow-md border rounded-b-lg z-10 max-h-64 overflow-y-auto"
// //         >
// //           {loading && (
// //             <p className="p-2 text-gray-500 text-sm">Loading suggestions...</p>
// //           )}

// //           {!loading && suggestions.length === 0 && (
// //             <p className="p-2 text-gray-500 text-sm">No suggestions found.</p>
// //           )}
...
// //               >
// //                 {item.label} <span className="text-gray-400 text-xs">({item.type})</span>
// //               </div>
// //             ))}
// //         </div>
// //       )}
...
// // const SearchBox = ({ placeholder = "Search...", fetchSuggestions, onSelect }) => {
// //   const [inputValue, setInputValue] = useState("");
// //   const [suggestions, setSuggestions] = useState([]);
// //   const [showSuggestions, setShowSuggestions] = useState(false);
// //   const [loading, setLoading] = useState(false);
...
// //   // Debounced function (only fires if user stops typing for 300ms)
// //   const debouncedFetch = useRef(
// //     debounce(async (value) => {
...
// //     const val = e.target.value;
// //     setInputValue(val);
// //     debouncedFetch(val); // use debounce here
// //   };
...
//           className="absolute top-full left-0 right-0 bg-white shadow-md border rounded-b-lg z-10 max-h-64 overflow-y-auto"
//         >
//           {loading && <p className="p-2 text-gray-500 text-sm">Loading suggestions...</p>}
...
//               <div
//                 key={idx}
//                 className={`p-2 cursor-pointer ${idx === activeIndex ? "bg-blue-100" : "hover:bg-gray-100"}`}
//                 onMouseEnter={() => setActiveIndex(idx)}
//                 onClick={() => handleSelect(item.type, item.value)}
//               >
//                 {item.label} <span className="text-gray-400 text-xs">({item.type})</span>
